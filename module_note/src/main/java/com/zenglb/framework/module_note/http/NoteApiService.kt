package com.zenglb.framework.module_note.http



import com.zenglb.framework.module_note.UserObjectTestBean
...
interface NoteApiService {
     ...
     * 本API 依赖Flora项目
     */
    @GET("http://10.39.231.102:8889/getUsers")
    fun getUsers(): Observable<HttpResponse<List<UserObjectTestBean>>>
     ...
     * 本API 依赖Flora项目
     */
    @GET("http://10.39.231.102:8889/propertyStr")
    fun getPropertyStr(): Observable<HttpResponse<String>>
    ...
    //     * @return
    //     */
    //    @GET("http://localhost:8889/propertyStr")
    //    Observable<HttpResponse<UserBean>> getPropertyStr();
