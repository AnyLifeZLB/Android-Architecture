...
public class AGlobalModule {
    ...
    @Provides
    @Singleton
    public AModuleApiService provideApiService(SPDao spDao, Context mContext) {
        //Retrofit 的create 真是精华所在啊！
        return HttpRetrofit.getRetrofit(spDao, mContext).create(AModuleApiService.class);
    }
