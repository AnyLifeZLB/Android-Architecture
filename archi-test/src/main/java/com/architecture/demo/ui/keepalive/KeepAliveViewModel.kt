...
class KeepAliveViewModel : ViewModel() {
    ...
    fun postJsonData(mContext: Application) {
        ...
        viewModelScope.launch {
            ...
            val wifiService = mContext.getSystemService(AppCompatActivity.WIFI_SERVICE) as WifiManager

            val json = JsonBean(
                Build.BRAND+" --Arch-- "+batteryManager.getIntProperty(BatteryManager.BATTERY_PROPERTY_CAPACITY),
