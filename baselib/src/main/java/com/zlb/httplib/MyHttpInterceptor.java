...
public final class MyHttpInterceptor implements Interceptor {
    ...
    private volatile MyHttpInterceptor.Level level = MyHttpInterceptor.Level.NONE;

    /**
     * Change the level at which this interceptor logs.
     */
    public MyHttpInterceptor setLevel(MyHttpInterceptor.Level level) {
        if (level == null) throw new NullPointerException("level == null. Use Level.NONE instead.");
        this.level = level;
        return this;
    }

    public MyHttpInterceptor.Level getLevel() {
        return level;
    }
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        if (level == MyHttpInterceptor.Level.NONE) {
